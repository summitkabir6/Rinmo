      ...
      <main className="pt-28 pb-24 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-8 text-[var(--text-muted)] text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-white text-lg font-semibold mb-3">2. Early access pilot</h2>
              <p>
            ...
            <section>
              <h2 className="text-white text-lg font-semibold mb-3">3. Use of the service</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-white text-lg font-semibold mb-3">4. Data ownership</h2>
              <p>
            ...
            <section>
              <h2 className="text-white text-lg font-semibold mb-3">6. Disclaimers</h2>
              <p className="mb-3">
            ...
            <section>
              <h2 className="text-white text-lg font-semibold mb-3">8. Changes to terms</h2>
              <p>
